      ...
      <div className="flex w-full overflow-hidden py-4">
        ...
        >
          {duplicatedReviews.map((review, i) => (
            ...
            >
              <div 
                className="w-[280px] md:w-[480px] bg-white rounded-2xl md:rounded-[32px] p-3.5 md:p-6 shadow-[0_4px_20px_rgba(0,0,0,0.04)] md:shadow-[0_10px_35px_rgba(0,0,0,0.04)] border border-[#2d4a3e]/20 flex flex-row md:flex-row items-center gap-3 md:gap-6 hover:shadow-lg transition cursor-h-auto"
              >
                {/* 좌측: 이미지 영역 (모바일은 아기자기하게, PC는 큼직하게) */}
                {review.image_url && (
                  <div className="w-[90px] h-[90px] md:w-[150px] md:h-[150px] flex-shrink-0 bg-slate-100 rounded-xl md:rounded-2xl overflow-hidden relative">
                    <img 
