  ...
  <div className="w-full overflow-x-auto_tab1">
    <div className="min-w-[767px] mx-auto rounded-[10px] overflow-hidden shadow-[0_4px_24px_0_rgba(0,0,0,0.08)] border border-stone-300">
      ...
      <div className="grid grid-cols-4 border-t border-stone-300 text-center text-sm lg:text-base font-medium">
        ...
        <section className="w-full max-w-[1100px] mx-auto space-y-10 mb-10">
            <h3 className="text-black lg:text-3xl text-xl font-bold">휴대폰 회선 수에 따른 결합 할인금액</h3>
            <div className="w-full overflow-x-auto lg:my-10 my-6">
                <div className="min-w-[767px] mx-auto rounded-[10px] overflow-hidden shadow-[0_4px_24px_0_rgba(0,0,0,0.08)] bg-white">
                    ...
                    <div className="grid grid-cols-12 border border-stone-300 items-stretch">
                        ...
                        <div className="col-span-2 flex flex-col border-r border-stone-300 min-w-0">
                            <span className="flex flex-col border-b items-center border-stone-300 justify-center bg-white py-4 gap-1 text-black text-sm font-normal leading-[1.35] text-center min-w-0">
                                69,000원 미만
                            </span>
                            <span className="flex flex-col border-b items-center border-stone-300 justify-center bg-white py-4 gap-1 text-black text-sm font-normal leading-[1.35] text-center min-w-0">
                                69,000원 이상
                            </span>
                            <span className="flex flex-col items-center border-stone-300 justify-center bg-white py-4 gap-1 text-black text-sm font-normal leading-[1.35] text-center min-w-0">
                                88,000원 이상
                            </span>
                        </div>
                    ...
                    <div className="grid grid-cols-6 border border-stone-300 border-t-0 items-stretch">
                        <span className="flex flex-col items-center justify-center border-r border-stone-300 bg-white py-4 gap-1 text-black text-sm font-normal min-w-0">
                            투게더 결합
                        </span>
                        <span className="flex flex-col items-center border-r justify-center border-stone-300 bg-white py-4 gap-1 text-black text-sm font-normal min-w-0">
                            88,000원 이상
                        </span>
                        <span className="flex flex-col items-center justify-center border-r border-stone-300 bg-white py-4 gap-1 text-black text-sm font-normal min-w-0">
                            할인X
                        ...
                        <span className="flex flex-col items-center justify-center bg-white py-4 gap-1 text-black text-sm font-normal min-w-0">
                            20,000원
                        </span>
                    </div>
                    ...
                    <div className="grid grid-cols-12 border border-stone-300 border-t-0 bg-stone-50 items-stretch">
                        <span className="flex flex-col items-center justify-center col-span-2 border-r border-stone-300 bg-stone-50 py-4 gap-1 text-black text-sm font-bold min-w-0">
                        </span>
                        <span className="flex flex-col items-center justify-center col-span-2 border-stone-300 border-r bg-stone-50 py-4 gap-1 text-black text-sm font-bold min-w-0">
                            100M
                        </span>
                        <span className="flex flex-col items-center justify-center col-span-4 border-stone-300 border-r bg-stone-50 py-4 gap-1 text-black text-sm font-bold min-w-0">
                            500M
                        </span>
                        <span className="flex flex-col items-center justify-center col-span-4 border-stone-300 bg-stone-50 py-4 gap-1 text-black text-sm font-bold min-w-0">
                            1G
                        </span>
                    </div>
                    ...
                    <div className="grid grid-cols-12 border border-stone-300 border-t-0 items-stretch">
                        ...
                        <span className="flex flex-col items-center justify-center col-span-2 border-stone-300 border-r bg-white py-4 gap-1 text-black text-sm font-normal min-w-0">
                            5,500원
                        </span>
                        <span className="flex flex-col items-center justify-center col-span-4 border-stone-300 border-r bg-white py-4 gap-1 text-black text-sm font-normal min-w-0">
                            9,900원
                        </span>
                        <span className="flex flex-col items-center justify-center col-span-4 border-stone-300 bg-white py-4 gap-1 text-black text-sm font-normal min-w-0">
                            13,200원
                        </span>
                    </div>
                    ...
                    <div className="grid grid-cols-12 border border-stone-300 border-t-0 items-stretch">
                        ...
                        <span className="flex flex-col items-center justify-center col-span-8 border-stone-300 bg-white py-4 gap-1 text-black text-sm font-normal min-w-0">
                            11,000원
                        </span>
                    </div>
