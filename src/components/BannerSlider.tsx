        ...
        >
          {banners.map((banner, index) => (
            <SwiperSlide key={banner.id || index} className="h-full">
              {/* 💡 핵심 수정: 모바일(aspect-[1/1])과 태블릿/일반PC 구간에서는 이미지가 잘리지 않게 object-contain과 배경색을 맞추고, 완벽한 데스크탑(lg:)에서만 고유 비율(2329/1300) 적용 */}
              <div className="relative w-full h-full min-h-[320px] lg:min-h-0 overflow-hidden aspect-[1/1] sm:aspect-[4/3] lg:aspect-[2329/1300] bg-[#e3eae5]">
