    ...
    <div>
      ...
      <section className="container py-10 lg:py-20 space-y-10">
        ...
        <div className="w-full mx-auto space-y-8">
          <div className="w-full overflow-x-auto">
            <div className="min-w-[767px] mx-auto rounded-[10px] overflow-hidden shadow-[0_4px_24px_0_rgba(0,0,0,0.08)] border border-stone-300">
              <div className="bg-[#0f382b] grid grid-cols-3 py-4 text-white font-bold text-center text-sm lg:text-lg">
              ...
              <div className="grid grid-cols-3 border-t border-stone-300 text-center text-sm lg:text-base font-medium">
                <div className="flex items-center justify-center p-4 border-r border-stone-300 font-extrabold text-[#0f382b]">인터넷 + 휴대폰</div>
        ...
        <section className="container space-y-10">
          ...
          <div className="w-full overflow-x-auto lg:my-10 my-6">
            <div className="min-w-[767px] mx-auto rounded-[10px] overflow-hidden shadow-[0_4px_24px_0_rgba(0,0,0,0.08)]">
              ...
              {/* 헤더 */}
              <div className="bg-[#0f382b] border-t border-x border-stone-300 grid grid-cols-5 items-center justify-center h-10 lg:h-14 relative text-white text-sm lg:text-base font-bold text-center">
                  <span>구분</span>
                  <span>결합 종류</span>
                  <span>100M</span>
                  <span>500M</span>
              ...
              <div className="grid grid-cols-5 border border-stone-300 text-center text-sm lg:text-base font-medium bg-white">
                  <div className="flex items-center justify-center border-r border-stone-300 py-4 font-bold text-[#0f382b]">LG / KT / SK</div>
                    ...
                    <div className={`flex flex-col ${rowSpan > 1 ? '' : 'justify-center'}`}>
                      {item.cards.map((card, idx) => (
                        <div key={idx} className={`grid grid-cols-[1fr,1fr] h-full ${idx !== rowSpan - 1 ? 'border-b border-stone-300' : ''}`}>
                          ...
                          {/* 카드명 셀 */}
                          <div className="border-r border-stone-300 font-bold text-[#0f382b] flex items-center justify-center p-4 px-1 h-full">
                            {card}
                          </div>
        ...
        <p className="text-stone-500 lg:text-3xl text-xl text-center !leading-[1.3] lg:pt-10 pt-6">
          <span className="text-[#0f382b] font-bold block">가장 결합 혜택이 좋은 LG헬로비전!</span>
